...
CREATE TABLE `classifiers` (
  ...
  `name` varchar(255) NOT NULL default '',
  `type` int(11) NOT NULL default '0',
  `classifier_id_external` varchar(255) NOT NULL default '',
...
CREATE TABLE `tc_applications` (
  ...
  `session_id` int(11) NULL,
  `session_department_id` int(11) NULL,
  ...
  `period` varchar(16) NULL,
	`criterion_id` int(11) NULL,
	`category` int(11) NULL,
	`created` DATETIME NULL,
	`expire` DATE NULL,
	`primary_type` int(11) NULL,
	`criterion_type` int(11) NULL,
	`status` int(11) NULL,
	`goal` int(11) NULL,
...
CREATE TABLE IF NOT EXISTS `tc_feedbacks` (
...
DROP TABLE IF EXISTS `tc_provider_contacts`;
...
DROP TABLE IF EXISTS `tc_provider_teachers`;
...
DROP TABLE IF EXISTS `tc_provider_teachers2subjects`;
CREATE TABLE `tc_provider_teachers2subjects` (
  `teacher_id` int(11) NULL auto_increment,
  `provider_id` int(11) NULL,
  `subject_id` int(11) NULL,
  KEY  (`teacher_id`, `provider_id`)  
) ;

DROP TABLE IF EXISTS `tc_providers`;
CREATE TABLE `tc_providers` (
  `provider_id` int(11) NOT NULL auto_increment,
  `name` varchar(255) NULL,
  `description` text NULL,
  `status` tinyint(11) NULL,
  `address_legal` text NULL,
  `address_postal` varchar(1) NULL,
  `inn` varchar(32) NULL,
  `kpp` varchar(32) NULL,
  `bik` varchar(32) NULL,
...
DROP TABLE IF EXISTS `tc_session_departments`;
CREATE TABLE `tc_session_departments` (
  `session_department_id` int(11) NOT NULL auto_increment,
  `department_id` int(11) NULL,
  `session_id` int(11) NULL,
...
CREATE TABLE `subjects` (
  ...
  `format` int(11) NULL,
  `city` int(11) NULL,
  `mark_required` int(11) NULL,
  `check_form` int(11) NULL,
  `after_training` int(11) NULL,
  `feedback` int(11) NULL,
  `status` tinyint(4) default '0',
  `created` datetime NULL,
  `created_by` int(11) NULL,
  PRIMARY KEY  (`subid`),
...
DROP TABLE IF EXISTS `state_of_process_data`;
CREATE TABLE `state_of_process_data` (
  `state_of_process_data_id` int(11) NOT NULL auto_increment,
  `state_of_process_id` int(11) NOT NULL,
  `state` varchar(255) NOT NULL,
  `begin_date` datetime NOT NULL,
  `begin_by_user_id` int(11) NULL,
  `begin_auto` tinyint NOT NULL DEFAULT 0,
  `end_date` datetime NULL,
  `end_by_user_id` int(11) NULL,
...
INSERT INTO notice (`type`, EVENT, TITLE, RECEIVER, MESSAGE) VALUES (105,'Уведомление о сессии планирования для руководителей подразделений', 'Новая сессия планирования', 0, 'Уважаемый руководитель, добрый день. Прошу запланировать дополнительное обучение для своих сотрудников до [PLAN_DATE_END]. Норматив на обучение одного сотрудника – [PLAN_AMOUNT] рублей.');
INSERT INTO notice (`type`, EVENT, TITLE, RECEIVER, MESSAGE) VALUES (106,'Уведомление о запланированном обучении', 'Запланированно обучение', 0, 'Уважаемый специалист, добрый день.Руководитель подразделения [DEP_ORG] запланировал обучение для своих сотрудников.');
...
CREATE OR REPLACE VIEW subjects_fulltime_session_rating AS
SELECT s.subid, s.base_id, COUNT(gr.mid) AS graduated, COUNT(gr.mid) * AVG(gr.effectivity) * AVG(sv.value) AS rating
		FROM subjects AS s
...
FROM subjects sub
INNER JOIN subjects_fulltime_session_rating AS rt ON rt.base_id=sub.subid
GROUP BY sub.subid;
