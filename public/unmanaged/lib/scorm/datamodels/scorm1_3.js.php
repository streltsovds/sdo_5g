...
<?php
    ...
    scorm_reconstitute_array_element('scorm_13', $userdata, 'cmi.objectives', array('score'));
    scorm_reconstitute_array_element('scorm_13', $userdata, 'cmi.interactions', array('objectives', 'correct_responses'));
    scorm_reconstitute_array_element('scorm_13', $userdata, 'cmi.comments_from_learner', array());
    scorm_reconstitute_array_element('scorm_13', $userdata, 'cmi.comments_from_lms', array());
?>
...
//            }
    ...
    function StoreData(data,storetotaltime) {
        ...
        var result = DoRequest(myRequest,"<?php echo $sitepath ?>scorm_datamodel.php?ModID=<?php echo $ModID?>&McID=<?php echo $McID?>&cid=<?php echo $cid?>&time=<?php echo $time?>",datastring);
