...
//        datastring += '&scoid=<?php echo $sco->id ?>';
        ...
        result = DoRequest(myRequest,"<?php echo $sitepath ?>scorm_datamodel.php?ModID=<?php echo $ModID?>&McID=<?php echo $McID?>&cid=<?php echo $cid?>&time=<?php echo $time?>",datastring);
