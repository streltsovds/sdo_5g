...
function removeDir($dir){
  ...
  if(!isset($GLOBALS['removeDirError']))
  $GLOBALS['removeDirError'] = false;
  ...
  if(!$GLOBALS['removeDirError']) // if no errors occured, delete the now empty directory.
   if(!rmdir($dir)){
