...
/* Дейолтная учётная запись и её роли*/

SET IDENTITY_INSERT People ON
INSERT INTO People (MID, LastName, FirstName, Password, Login) VALUES (1, 'Администратор', 'Администратор', dbo.PASSWORD('pass'), 'admin');
...
SET IDENTITY_INSERT at_managers ON
INSERT INTO at_managers (user_id) VALUES
  (1);
SET IDENTITY_INSERT at_managers OFF
...
SET IDENTITY_INSERT recruit_providers ON
...
SET IDENTITY_INSERT recruit_providers OFF
...
SET IDENTITY_INSERT classifiers_types ON
...
SET IDENTITY_INSERT classifiers_types OFF
...
SET IDENTITY_INSERT forums_list ON
...
SET IDENTITY_INSERT forums_list OFF

SET IDENTITY_INSERT forums_sections ON
...
SET IDENTITY_INSERT forums_sections OFF
...
/*
SET IDENTITY_INSERT programm ON
...
SET IDENTITY_INSERT programm OFF

SET IDENTITY_INSERT programm_events ON
...
SET IDENTITY_INSERT programm_events OFF

SET IDENTITY_INSERT at_evaluation_type ON
...
SET IDENTITY_INSERT at_evaluation_type OFF
...
set identity_insert quest_clusters on
INSERT INTO quest_clusters (cluster_id, quest_id, name) VALUES
  (1,1,'Результаты прохождения программы адаптации');
set identity_insert quest_clusters off

set identity_insert quest_questions on
...
set identity_insert quest_questions off

set identity_insert quest_question_variants on
...
set identity_insert quest_question_variants off
