...
<!--                    <path fill="none" stroke="#00A551" stroke-width="4" d="M5 50a45 45 0 1 1 90 0 45 45 0 1 1-90 0" style="animation:NDECXEIV_draw_0 5000ms ease-in 0ms infinite,NDECXEIV_fade 5000ms linear 0ms infinite" stroke-dasharray="283 285" stroke-dashoffset="284"/>-->
<!--                    <path fill="none" stroke="#00A551" stroke-width="2.5" d="M31.2 76.8c-.9 0-1.7-.3-2.4-.9-.6-.6-1-1.5-1-2.4V48.4c0-1.8 1.5-3.3 3.3-3.3 1.8 0 3.3 1.5 3.3 3.3v21.9h32.5V48.4c0-.9.3-1.7.9-2.4.6-.6 1.5-.9 2.4-.9h5.3L50.6 24.4 20.9 49.2c-1.3 1.1-3.5 1-4.6-.4-1.1-1.3-1-3.5.4-4.6l31.8-26.5c1.2-1 2.9-1 4.2 0l31.8 26.5c.8.7 1.1 1.6 1.1 2.5v1.7c0 1.8-1.5 3.3-3.3 3.3h-9.1v21.9c0 .9-.3 1.7-.9 2.4-.6.6-1.5.9-2.4.9H31.2v-.1z" style="animation:NDECXEIV_draw_1 5000ms ease-in 0ms infinite,NDECXEIV_fade 5000ms linear 0ms infinite" stroke-dasharray="381 383" stroke-dashoffset="382"/>-->
 ...
 */
?>
<div v-cloak id="hm-vue-app" :class="appComputedAppCssClasses" class="app-layout-naked">
