...
class HM_View_Infoblock_SubjectsProgressBlock extends HM_View_Infoblock_Abstract
{
    protected $id = 'subjectsProgressBlock';

    public function subjectsProgressBlock()
    {
        $soid = Zend_Registry::get('session_namespace_default')->subj_prgrs->soid;
        $profileId = Zend_Registry::get('session_namespace_default')->subj_prgrs->profileId;
        ...
        $content = $this->view->render('subjectsProgressBlock.tpl');
