...
class HM_View_Infoblock_HiringDismissalByDepartmentsBlock extends HM_View_Infoblock_Abstract
{
    protected $id = 'hiringDismissalByDepartments';

    public function hiringDismissalByDepartmentsBlock($param = null)
    {
        $fromDate = Zend_Registry::get('session_namespace_default')->hrds_by_dep->fromDate;
        $toDate = Zend_Registry::get('session_namespace_default')->hrds_by_dep->toDate;
        $soid = Zend_Registry::get('session_namespace_default')->hrds_by_dep->soid;
        ...
        $content = $this->view->render('hiringDismissalByDepartmentsBlock.tpl');
