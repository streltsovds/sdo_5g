<?php
class HM_Recruit_Reservist_Import_Template_TemplateService extends HM_Service_Import_Abstract
{
    ...
    public function getForm()
    {
        ...
        $form->getElement('file')->setOptions(
            array(
                ...
                'file_upload_limit' => 1,
                'file_sample' => Zend_Registry::get('config')->url->base . 'samples/staff-reserve-external-import-template.xlsx',
                'Required' => true
            )
        );
