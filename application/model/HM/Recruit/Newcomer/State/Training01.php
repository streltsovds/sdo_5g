<?php
class HM_Recruit_Newcomer_State_Training01 extends HM_Recruit_Newcomer_State_Abstract
{
    public function getActions()
    {
        ...
        if ($this->getStatus() == HM_State_Abstract::STATE_STATUS_CONTINUING) {
            ...
            $actions[] = new HM_State_Action_Link(array(
                    ...
                    'confirm' => _('Вы действительно подтверждаете факт прохождения вводного инструктажа пользователем?'),
                ), array(
    ...
    {
        return _('На этом этапе пользователь проходит вводный инструктаж.');
    }
}