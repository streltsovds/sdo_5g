 ...
 *
 */
class HM_At_Evaluation_Method_Competence_ParentreserveModel extends HM_At_Evaluation_Method_CompetenceModel implements HM_At_Evaluation_Method_Interface
{
    ...
    public function getDefaults($user)
    {
        ...
        return array(
            'name' => sprintf($msg = _('Оценка компетенций участника кадрового резерва %s'), $user->getName()),
        );
    }
