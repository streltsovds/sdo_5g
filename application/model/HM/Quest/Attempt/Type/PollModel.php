<?php
class HM_Quest_Attempt_Type_PollModel extends HM_Quest_Attempt_Type_Abstract
{
    public function updateByType()
    {
        ...
        if(!isset($this->context_event_id)) return;//Потом надо будет сделать культурно, не передается митинг
