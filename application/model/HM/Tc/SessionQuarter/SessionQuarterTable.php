...
class HM_Tc_SessionQuarter_SessionQuarterTable extends HM_Db_Table
{
    protected $_name = "tc_sessions_quarter";
    protected $_primary = "session_quarter_id";
    protected $_sequence = "S_106_1_TC_SESSIONS_QUARTER"; // ??
    ...
    {
        return array('tc_sessions_quarter.session_id ASC');
    }
}