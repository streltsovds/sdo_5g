...
class HM_Tc_SessionQuarter_Department_State_Agreement extends HM_State_Abstract
{
...
//        }
        ...
        $sessionService = $this->getService('TcSessionQuarter');
        $processService = $this->getService('Process');
        $session = $sessionService->getOne($sessionService->find($this->_params['session_quarter_id']));
    ...
    {
        return _('На этом этапе проходит согласование уточненной консолидированной заявки с ответственными лицами.
            Переводя консолидированную заявку на следующий этап, специалист по обучению подтверждает, что она
            согласована со всеми ответственными лицами.
            ');
    }
    ...
    {
        return _("При утверждении консолидированной заявки возникли непредвиденные ошибки.");
    }
    ...
    {
        return _('Согласование консолидированной заявки');
    }
    ...
    public function getActions()
    {
        ...
        /*$actions[] = new HM_State_Action_Link(array(
                'url' => array('module' => 'session', 'controller' => 'list', 'action' => 'view', 'session_id' => $params['session_id'], 'baseUrl' => 'tc'),
        ...
        if ($this->getStatus() == HM_State_Abstract::STATE_STATUS_CONTINUING) {
            ...
            $actions[] = new HM_State_Action_Link(array(
                    'url' => array(
                        ...
                        'baseUrl' => 'tc'),
                    'title' => _('Завершить согласование консолидированной заявки')
                ),array(
