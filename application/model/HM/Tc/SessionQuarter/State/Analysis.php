...
class HM_Tc_SessionQuarter_State_Analysis extends HM_State_Abstract
{
    ...
    {
        return _('На этом этапе менеджер по обучению проверяют список заявок на квартал и назначают участников обучения на конкретные учебные сессии.');
    }
