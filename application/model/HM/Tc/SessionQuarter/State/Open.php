...
class HM_Tc_SessionQuarter_State_Open extends HM_State_Abstract
{
    ...
    {
        return _('На этом этапе уточняются параметры сессии квартального планирования; доступ для руководителей подразделений закрыт.');
    }
    ...
    {
        return _('Старт сессии планирования');
    }
