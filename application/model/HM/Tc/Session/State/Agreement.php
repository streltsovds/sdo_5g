...
class HM_Tc_Session_State_Agreement extends HM_State_Abstract
{
    ...
    {
        return _('На этом этапе консолидированные заявки объединяются в план обучения, план утверждается ответственными лицами.');
    }
