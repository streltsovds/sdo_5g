...
class HM_Tc_Session_State_Open extends HM_State_Abstract
{
    ...
    {
        return _('На этом этапе уточняются параметры сессии годового планирования; доступ для руководителей подразделений закрыт.');
    }
