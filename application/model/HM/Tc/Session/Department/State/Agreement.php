...
class HM_Tc_Session_Department_State_Agreement extends HM_State_Abstract
{
    public function onStateStart()
    {
        ...
        try {
            ...
            $messenger->send(HM_Messenger::SYSTEM_USER_ID, $session->responsible_id);
        } catch (Exception $exc) {
        }
    ...
    {
        return _('На этом этапе проходит согласование консолидированной заявки с ответственными лицами.
