<?php
class HM_Hr_Reserve_File_FileModel extends HM_Model_Abstract
{
    ...
    public static function getStateTypes()
    {
        if (!static::$_processes) {
            static::$_processes = Zend_Registry::get('serviceContainer')->getService('Process')->getStaticProcess(HM_Process_ProcessModel::PROCESS_PROGRAMM_RESERVE);
        }
        return array (
