<settings>
  ...
  <balloon>
    ...
    <border_color>#DFCA51</border_color>
    <alpha>80</alpha>
  </balloon>
  ...
  <graphs>
    <graph gid="yield-trainings">
      <color>#F15B0F</color>
      <line_width>2</line_width>
      <fill_alpha>10</fill_alpha>
      <fill_color>#F15B0F</fill_color>
      <bullet>round_outline</bullet>
      <bullet_size>8</bullet_size>
      <bullet_alpha>100</bullet_alpha>
      <bullet_color>#F15B0F</bullet_color>
      <balloon_text>
	      <![CDATA[Количество проведенных учебных сессий с начала года: {value}]]>
      </balloon_text>
    </graph>
    <graph gid="yield-trainees">
      <color>#F15B0F</color>
      <line_width>2</line_width>
      <fill_alpha>10</fill_alpha>
      <fill_color>#F15B0F</fill_color>
      ...
      <bullet_color>#F15B0F</bullet_color>
      <balloon_text>
	      <![CDATA[Количество прошедших обучение с начала года: {value}]]>
      </balloon_text>
    </graph>
    <graph gid="yield-coverage">
      <color>#F15B0F</color>
      <line_width>2</line_width>
      <fill_alpha>10</fill_alpha>
      <fill_color>#F15B0F</fill_color>
