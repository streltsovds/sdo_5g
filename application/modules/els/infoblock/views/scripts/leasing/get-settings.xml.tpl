...
<indicator>
  ...
  <graphs>
    ...
    <graph gid="leasing-sessions">
      <color>#003F7E</color>                      
      <line_width>2</line_width>                  
      <balloon_text>
	      <![CDATA[<?php echo _('Максимальное количество подключений в этот день');?>: {value}]]>
      </balloon_text>    
    </graph>      
    <graph gid="leasing-hdd">
      <color>#D4B922</color>                      
      <line_width>2</line_width>                  
      <balloon_text>                                                    
	      <![CDATA[<?php echo _('Объём дискового пространства, Гб');?>: {value}]]>
      </balloon_text>    
    </graph>      
  </graphs>
