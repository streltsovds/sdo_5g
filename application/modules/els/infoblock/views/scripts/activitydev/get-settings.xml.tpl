...
<indicator>
  ...
  <graphs>
    <graph gid="activitydev-times">                          
      <color>#003F7E</color>                      
      <line_width>2</line_width>                  
      <balloon_text>                                                    
	      <![CDATA[<?php echo _('Среднее количество пользователей в это время');?>: {value}]]>
      </balloon_text>    
    </graph>      
    <graph gid="activitydev-dates">                          
      <color>#D4B922</color>                      
      <line_width>2</line_width>                  
      <balloon_text>                                                    
	      <![CDATA[<?php echo _('Среднее количество пользователей в этот день');?>: {value}]]>
      </balloon_text>    
    </graph>      
  </graphs>
