 ...
 *
 */
class HM_Subject_DataGrid_MassAction_Materials_CreateExtras extends HM_DataGrid_MassAction
{
	static public function create(HM_DataGrid $dataGrid, $name, array $options = array())
	{
		...
		if ($serviceContainer->getService('Acl')->checkRoles([
			...
			$url = array('module' => 'subject', 'controller' => 'extras', 'action' => 'create-by-material');
