    ...
    public function indexAction()
    {
        ...
        $select->from(
            ...
            ->joinLeft(
                ...
                array())
            ->group(array('t1.MID', 't1.LastName', 't1.FirstName', 't1.Patronymic', 't1.blocked', 't1.Login', 'r.item_id', 't2.user_id'));

        if (!$switcher) {

            $select->joinInner(
                array('t2' => 'supervisors'),
                't1.MID = t2.user_id',
                array()
            );
        ...
        $grid->setGridSwitcher([
            ...
            'title' => _('Показать всех руководителей подразделений'),
