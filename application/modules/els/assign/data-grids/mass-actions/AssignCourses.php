 ...
 *
 */
class HM_Assign_DataGrid_MassAction_AssignCourses extends HM_DataGrid_MassAction
{
        ...
        if ($serviceContainer->getService('Acl')->inheritsRole(
            ...
            switch ( Zend_Controller_Front::getInstance()->getRequest()->getControllerName() ){
                case 'teacher':
                    ...
                    $assignMenuItem = ($options['courseId'] > 0) ? _('Назначить тьюторов на курс') : _('Назначить тьюторов на курсы');
                    break;
                case 'student':
