...
<?php if (!$this->isAjaxRequest):?>
    <form class="grid-filters-from" method="post" style="margin: 20px 0;">
...
<div class="at-form-report">
    <div class="report-summary clearfix">
        <div class="right-block">
            <h4 style="padding: 10px 0;">Средняя стоимость вакансии за выбранный период</h4>
            <?php echo $this->reportList($this->subGrid);?>
        </div>
    </div>
</div>
