<?php
class HM_Form_ApplicationQuarter extends HM_Form
{
    ...
    public function init()
    {
        ...
        $sessionId = $this->getParam('session_quarter_id');
        ...
        $this->addElement($this->getDefaultSelectElementName(), $commonGroup[] = 'user_id', array(
