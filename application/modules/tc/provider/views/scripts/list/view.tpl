<div class="at-form-report">
    ...
    <div class="report-summary clearfix">
        <div class="left-block">
            ...
            <?php echo $this->reportList($this->provider->getCardFields());?>
        </div>
    ...
    <h2><?php echo  _('Информация для пользователей');?><?php if($this->canEdit):?><a class="edit" href="<?php echo $this->url(array('module' => 'provider', 'controller' => 'list', 'action' => 'edit'))?>" class="edit">&nbsp;</a><?php endif; ?></h2>
    <div class="clearfix">
        <?php echo $this->details['information'];?>
    </div>
</div>
