...
class HM_Form_Sessions extends HM_Form {
    ...
    public function initWithData($subjects, $postMassIds)
    {
        ...
        foreach ($subjects as $subject) {
            ...
            $this->addElement('hidden', "subject_{$subject->subid}_roomId",
                array(
                )
            );
            ...
            $this->addElement('RadioGroup', "radio_notifications", array(
                'Label' => '',
                'MultiOptions' => array(
                    0 => _('Отправить типовое уведомление'),
                    1 => _('Скорректировать текст стандартного уведомления'),
                    2 => _('Не отправлять уведомление'),
                ),
                'value' => 0,
                'separator' => '',
                'form' => $this,
            ...
            $this->addDisplayGroup(array(
                ...
                "fieldset_notifications",
                array('legend' => _('Уведомления'))
            );
        }
