...
class Zend_Date extends Zend_Date_DateObject
{
    ...
    private function _parseIsoToDate($token, $locale) {
        switch($token) {
            ...
            case self::YEAR_8601 :
// Это проблема периодически встречаетсяна датах на границе года, например, при переводе 31.12.2014, получаем  31.12.2015, т.е. фактически сдвиг на 365 дней. 
                return self::YEAR_8601;//'o';
//
                break;
     ...
     * @return Zend_Date Provides fluid interface
     * @throws Zend_Date_Exception
     * @see https://github.com/zf1s/zend-date/commit/579f36672ca47ef13e962ea779eb0a7caafa5689
     */
