    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    public function htmlify(Zend_Navigation_Page $page)
    {
        ...
        $page_key = array_keys($page->_params);
        $page_value = (array_values($page->_params));
        ...
        if ($page->_module == 'newcomer')  {
            $attribs['href'] = '/recruit/newcomer/'.$page->_controller.'/'.$page->_action.'/'.$page_key[0].'/'.$page_value[0].'/';
        } else {
