...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    {
        return ($this->getHeader('X_REQUESTED_WITH') == 'XMLHttpRequest') || ($this->getHeader('IS_AJAX_REQUEST') == 'TRUE');
    }
    ...
    public function getHeader($header)
    {
        ...
        // хак для php в режиме CGI
        // должна быть соответствующая конструкция в .htaccess
