...
//            'custom_messages' => $this->getCustomMessages() ? $this->getCustomMessages() : null,
            'description' => $this->getDescription(),
            'label' => $this->getLabel(),
//            'legend' => $this->getLegend() ? $this->getLegend() : null,
            'value' => $this->getValue(),
            'fully_qualified_name' => $this->getFullyQualifiedName(),
            'messages' => $this->getMessages(),
