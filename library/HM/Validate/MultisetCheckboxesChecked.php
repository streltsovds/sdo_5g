<?php
class HM_Validate_MultisetCheckboxesChecked extends Zend_Validate_Abstract
{
    ...
    /**
     * @param HM_Form_Element_MultiSet $multiSet
     * @return bool
     * @throws Zend_Validate_Exception
     */
    public function isValid($multiSet)
    {
        if (!($multiSet instanceof HM_Form_Element_Vue_MultiSet)) {
            throw new Zend_Validate_Exception('Value is not instanceof HM_Form_Element_MultiSet');
        }

        $elements = $multiSet->getElements();
