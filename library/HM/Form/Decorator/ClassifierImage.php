 ...
 */
class HM_Form_Decorator_ClassifierImage extends Zend_Form_Decorator_File
{
    /**
     * Render errors
     * 
    ...
    {    
        ...
        $classifier = $element->classifierType;
        
        $view = new Zend_View();

        if(method_exists($classifier, 'getIcon')){
            $url = $classifier->getIcon();
