...
require_once "SinergiBrowserDetector.php";
require_once "SinergiUserAgent.php";

/**
 * Browser Detection.
 */
class SinergiBrowser
{
    ...
    /**
     * @param null|string|SinergiUserAgent $userAgent
     *
     */
    public function __construct($userAgent = null)
    {
        if ($userAgent instanceof SinergiUserAgent) {
            $this->setUserAgent($userAgent);
        } elseif (null === $userAgent || is_string($userAgent)) {
            $this->setUserAgent(new SinergiUserAgent($userAgent));
        } else {
    ...
    {
        if (!isset($this->name)) {
            SinergiBrowserDetector::detect($this, $this->getUserAgent());
        }
     ...
     * @return $this
     */
    public function setUserAgent(SinergiUserAgent $userAgent)
    {
