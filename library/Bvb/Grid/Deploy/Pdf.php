 ...
 * @version    $Id: Pdf.php 1196 2010-05-23 22:50:12Z bento.vilas.boas@gmail.com $
...
class Bvb_Grid_Deploy_Pdf extends Bvb_Grid implements Bvb_Grid_Deploy_DeployInterface
{
    ...
    public function deploy ()
    {
        ...
        //logotipo FederaГ§ГЈo $font = Zend_Pdf_Font::fontWithName(Zend_Pdf_Font::FONT_HELVETICA);
        ...
        //Iniciar a contagem de pГЎginas
        $pagina = 1;
        ...
        if ( is_array($grid) ) {
            ...
            foreach ( $grid as $value ) {
                ...
                if ( $altura <= 80 ) {
                    ...
                    //Colocar novamento os tГ­tulos em cada pГЎgina
                    reset($titulos);
                    $i = 0;
                    $largura1 = 40;
                    $page->setFont($font, $cellFontSize + 1);
