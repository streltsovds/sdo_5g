<template>
  <div class="INFOBLOCK infoblock-hiring-dismissal-by-positions-block">
    <v-card-text class="infoblock-hiring-dismissal-by-positions-block_filter pb-0">
      <v-layout wrap>
        <v-flex xs12 sm6>
          <hm-date-picker
            ...
            name="infoblock-hiring-dismissal-by-positions-block_from"
            @input="
              beginDate = $event;
              loadData();
            "
        ...
        <v-flex xs12 sm6>
          <hm-date-picker
            ...
            name="infoblock-hiring-dismissal-by-positions-block_to"
            @input="
              endDate = $event;
              loadData();
            "
    ...
    <v-flex sm12 md12 class="infoblock-hiring-dismissal-by-positions-block_chart-container">
      <hm-chart
        :data="chartData"
        type="apexbar"
...
<style lang="scss">
  .infoblock-hiring-dismissal-by-positions-block {
    .apexcharts-toolbar {
      display: none;
    }
  ...
  .infoblock-hiring-dismissal-by-positions-block_filter {
    .hm-form-element {
      margin: 0 10px 0 0;
    }
  }
