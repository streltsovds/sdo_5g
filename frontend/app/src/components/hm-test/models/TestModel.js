...
class TestModel {
  ...
  get showCommentForQuestion() {
    if (this._model.model.attempt.method === 'competence') {
      return (
        this._model.model.scale.displaycomment === 1
      );
    }
    else return (
  ...
  get description() {
    if (this._model.model.attempt.method === 'competence') return this._model.model.scale.description;
    else return this._model.model.quest.description;
  }
  get title() {
    if (this._model.model.attempt.method === 'competence') return this._model.model.scale.name;
    else return this._model.model.quest.name;
  }
  get progress() {
